...
String words[] = {
    "pian", "calculator", "sticla", "copil", "creion", "floare", 
    "culoare", "timp", "aventura", "muzica", "poveste", "film",
    "oras", "glob", "univers", "energie", "val", "munte",
    "galaxie", "cantec", "nor", "dragoste", "viata", "pasiune",
    "vis", "ciocolata", "vant", "minge", "planeta", "ritm"
};
...
void setup() {
  ...
  randomSeed(analogRead(0)); // Seed the random function using an unconnected analog pin
